...
BINS = milestone1 milestone2 milestone3 milestone4 milestone5 milestone6 milestone7 milestone8 milestone9 milestone10
...
milestone4 milestone5 milestone6 milestone7 milestone8 milestone9 milestone10: %: $(COMMON_OBJ) src/%.o
	$(CC) $(CFLAGS) -o $@ $^
